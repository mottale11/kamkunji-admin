-- Fixed Database Setup for Kamkunji Admin Dashboard
-- Run this in your Supabase SQL Editor

-- First, drop existing tables if they exist (this will remove all data)
DROP TABLE IF EXISTS admin_activity_log CASCADE;
DROP TABLE IF EXISTS pickup_points CASCADE;
DROP TABLE IF EXISTS shipping_rates CASCADE;
DROP TABLE IF EXISTS payments CASCADE;
DROP TABLE IF EXISTS user_profiles CASCADE;
DROP TABLE IF EXISTS item_submissions CASCADE;
...
CREATE INDEX idx_item_submissions_status ON item_submissions(status);
CREATE INDEX idx_item_submissions_seller_id ON item_submissions(seller_id);
